...
!
! AVISO: Este modelo segundo modelo inhabilita las respuestas breves las preguntas de desmabiguaci�n
! del parser del tipo:
...
!        print " --> es ahora masculino…." ; !infsp debug
    ...
    if (obj provides gender)
        ...
        { ! Los casos del switch estaban mal.
          ...
          1: give obj ~female ~pluralname; !infsp fix for I7 compatibility (en I7 no se puede asignar el 0 a gender, de 1 para arriba, s�)
...
!##############################################################################
! ELIMINAR DESDE AQU� HASTA EL FINAL SI NO SE DESEA QUE EL JUGADOR
...
{
0: "MODO POR DEFECTO: Puedes referirte a los objetos por sus nombres o por sus adjetivos. S�lo primar�n los primeros de cara a la desambiguaci�n con otros objetos.";
default: "MODO ESTRICTO: Los adjetivos s�lo ser�n v�lidos acompa�ados alg�n nombre del objeto.";
}
!rtrue;
];
!##############################################################################
