...
[ GetDressedSub
	player_gna obj i;
	player_gna = GetGNAOfObject(player);
	!! 1) Si algún objeto de vestuario sin vestir al alcance del PC, se intenta
	!! lanzar la acción ##Wear sobre ellos automáticamente:
	objectloop(obj has clothing && obj hasnt worn && TestScope(obj, player)) {
		print "(Primero";
		switch (_grammatical_inflection) {
			FIRST_PERSON_PRESENT:
				switch (player_gna) {
	...
	!! 2) Si no hay objetos de vestuario sin vestir al alcance del PC, imprime
	!! un mensaje de error adecuado:
	objectloop(obj has clothing && obj has worn
		...
		switch (Utils.get_grammatical_inflection()) {
			...
			FIRST_PERSON_PAST:
				switch (player_gna) {
					...
					3, 9,
					4, 10:
						"No teníamos qué ponernos.";
				}
			SECOND_PERSON_PAST:
				switch (player_gna) {
					0, 6,
					1, 7:
						"No tenías qué ponerte.";
					3, 9,
					4, 10:
						"No teníais qué poneros.";
				}
			THIRD_PERSON_PAST:
				switch (player_gna) {
					0, 6,
					...
					3, 9,
					4, 10:
						"No tenían qué ponerse.";
				}
			FIRST_PERSON_FUTURE:
				switch (player_gna) {
					0, 6,
					1, 7:
						"No tendré qué ponerme.";
					3, 9,
					4, 10:
						"No tendremos qué ponernos.";
				}
			SECOND_PERSON_FUTURE:
				switch (player_gna) {
					0, 6,
					1, 7:
						"No tendrás qué ponerte.";
					3, 9,
					4, 10:
						"No tendréis qué poneros.";
				}
			THIRD_PERSON_FUTURE:
				switch (player_gna) {
					0, 6,
