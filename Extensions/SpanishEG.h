...
!!==============================================================================
!!
!!	Archivo:			SpanishEG.inf
!!	Autor(es):		Emily Short <emshort@mindspring.com>
!!								J. Francisco Martín <jfm.lisaso@gmx.com>
!!								Mapache
!!	Idioma:				ES (Español)
...
!!
!!	5.5: 2024/10/30
!!		Ejecuta la rutina `before` de LibraryMessages antes de imprimir las 
!!		respuestas de las nuevas acciones, de manera que puedan reescribirse 
!!		los mensajes por defecto (si la rutina retorna `true` se finaliza la 
!!		ejecución y no se imprime ningún mensaje por defecto).
!!
!!------------------------------------------------------------------------------
!!
!!	NOTAS
...
[ DanceSub
	...
	if (~~RunRoutines(LibraryMessages, before)) {
...
Verb 'folla' 'copula'
	* animate -> HaveSexWith
	* '-te' / '-me' animate -> HaveSexWith
	* 'a//' / 'con' animate -> HaveSexWith
	* '-te' / '-me' 'a' animate -> HaveSexWith
;
...
Verb 'ten'
	* 'sexo' 'con' animate -> HaveSexWith
	* 'coito' 'con' animate -> HaveSexWith
;
VerboIrregular "tener" with imperativo 'ten';

Verb 'haz'
	* 'el' 'amor' 'con' animate -> HaveSexWith
;
