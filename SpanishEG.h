...
[ DanceSub gna;
	...
	switch (_grammatical_inflection) {
		...
		FIRST_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"No llegaré a ser un gran bailarín.";
				1, 7:	"No llegaré a ser una gran bailarina.";
				3, 9:	"No llegaremos a ser unos grandes bailarines.";
				4, 10:	"No llegaremos a ser unas grandes bailarinas.";
			}
		SECOND_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"No llegarás a ser un gran bailarín.";
				1, 7:	"No llegarás a ser una gran bailarina.";
				3, 9:	"No llegaréis a ser unos grandes bailarines.";
				4, 10:	"No llegaréis a ser unas grandes bailarinas.";
			}
		THIRD_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"No llegará a ser un gran bailarín.";
				1, 7:	"No llegará a ser una gran bailarina.";
				3, 9:	"No llegarán a ser unos grandes bailarines.";
				4, 10:	"No llegarán a ser unas grandes bailarinas.";
			}
	}
];
	...
	switch (_grammatical_inflection) {
		...
		SECOND_PERSON_PRESENT:
			switch (gna) {
				...
				3,4,9,10:	"Ahora no tenéis ganas en realidad.";
			}
		THIRD_PERSON_PRESENT:
			switch (gna) {
		...
		FIRST_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7:	"No tendré ganas.";
				3,4,9,10:	"No tendremos ganas.";
			}
		SECOND_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7:	"No tendrás ganas.";
				3,4,9,10:	"No tendréis ganas.";
			}
		THIRD_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7:	"No tendrá ganas.";
				3,4,9,10:	"No tendrán ganas.";
			}
	}
];
...
[ ShoutSub gna;
	...
	switch (_grammatical_inflection) {
		...
		FIRST_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7:	"Gritaré con fuerza.";
				3,4,9,10:	"Gritaremos con fuerza.";
			}
		SECOND_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7:	"Gritarás con fuerza.";
				3,4,9,10:	"Gritaréis con fuerza.";
			}
		THIRD_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7:	"Gritará con fuerza.";
				3,4,9,10:	"Gritarán con fuerza.";
			}
	}
];
...
[ SitSub gna;
	...
	switch (_grammatical_inflection) {
		...
		FIRST_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"Ya estaré bastante cómodo de pie.";
				1, 7:	"Ya estaré bastante cómoda de pie.";
				3, 9:	"Ya estaremos bastante cómodos de pie.";
				4, 10:	"Ya estaremos bastante cómodas de pie.";
			}
		SECOND_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"Ya estarás bastante cómodo de pie.";
				1, 7:	"Ya estarás bastante cómoda de pie.";
				3, 9:	"Ya estaréis bastante cómodos de pie.";
				4, 10:	"Ya estaréis bastante cómodas de pie.";
			}
		THIRD_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"Ya estará bastante cómodo de pie.";
				1, 7:	"Ya estará bastante cómoda de pie.";
				3, 9:	"Ya estarán bastante cómodos de pie.";
				4, 10:	"Ya estarán bastante cómodas de pie.";
			}
	}
];
...
[ UntieSub gna;
	...
	switch (_grammatical_inflection) {
		...
		FIRST_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"No estaré seguro de cómo hacer eso.";
				1, 7:	"No estaré segura de cómo hacer eso.";
				3, 9:	"No estaremos seguros de cómo hacer eso.";
				4, 10:	"No estaremos seguras de cómo hacer eso.";
			}
		SECOND_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"No estarás seguro de cómo hacer eso.";
				1, 7:	"No estarás segura de cómo hacer eso.";
				3, 9:	"No estaréis seguros de cómo hacer eso.";
				4, 10:	"No estaréis seguras de cómo hacer eso.";
			}
		THIRD_PERSON_FUTURE:
			switch (gna) {
				0, 6:	"No estará seguro de cómo hacer eso.";
				1, 7:	"No estará segura de cómo hacer eso.";
				3, 9:	"No estarán seguros de cómo hacer eso.";
				4, 10:	"No estarán seguras de cómo hacer eso.";
			}
	}
];
...
[ WriteSub gna;
	...
	switch (_grammatical_inflection) {
		...
		FIRST_PERSON_PAST:
		4:	switch (gna) {
				0,1,6,7: "No tenía nada que escribir en aquel momento.";
				3,4,9,10: "No teníamos nada que escribir en aquel momento.";
			}
		SECOND_PERSON_PAST:
			switch (gna) {
				0,1,6,7: "No tenías nada que escribir en aquel momento.";
				3,4,9,10: "No teníais nada que escribir en aquel momento.";
			}
		THIRD_PERSON_PAST:
			switch (gna) {
				0,1,6,7: "No tenía nada que escribir en aquel momento.";
				3,4,9,10: "No tenían nada que escribir en aquel momento.";
			}
		FIRST_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7: "No tendré nada que escribir en ese momento.";
				3,4,9,10: "No tendremos nada que escribir en ese momento.";
			}
		SECOND_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7: "No tendrás nada que escribir en ese momento.";
				3,4,9,10: "No tendréis nada que escribir en ese momento.";
			}
		THIRD_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7: "No tendrá nada que escribir en ese momento.";
				3,4,9,10: "No tendrán nada que escribir en ese momento.";
			}
	}
];
...
[ XyzzySub gna;
	...
	switch (_grammatical_inflection) {
		...
		FIRST_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7: "Un rumor silencioso responderá a mis palabras.";
				3,4,9,10: "Un rumor silencioso responderá a nuestras palabras.";
			}
		SECOND_PERSON_FUTURE:
			switch (gna) {
				0,1,6,7: "Un rumor silencioso responderá a tus palabras.";
				3,4,9,10: "Un rumor silencioso responderá a vuestras palabras.";
			}
		THIRD_PERSON_FUTURE:
